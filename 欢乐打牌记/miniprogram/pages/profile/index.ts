...
Page({
  data: {
    ...
    editName: '',
    editAvatar: '',
    activeEditField: null as 'avatar' | 'name' | null,
  ...
  loadHistoryStats() {
    ...
    history.forEach((room: RoomState) => {
  ...
  cancelEdit() {
    this.setData({
      activeEditField: null,
      editName: this.data.currentUser?.name || '',
      editAvatar: this.data.currentUser?.avatarUrl || '',
    });
  },
